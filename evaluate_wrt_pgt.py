...
def run(
    ...
    Args:
        ...
        sparse_npy_path (Path): Path to the .npy file containing
    ...
    sparse_eval_result = SparseEvalResult.load_from_npy(sparse_npy_path)
    if sparse_eval_result is None:
    ...
    error_file = evaluate_wrt_pgt(
        est_traj, gt_traj, sim3d, output_path
    )
